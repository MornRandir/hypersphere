...
var ProcessForm = function (settings) {
  this._settings = {
    ...
    attachmentsMaxFileSize: 500000, // дефолтный максимальный размер файла в Кб
    attachmentsFileExt: ['jpg','jpeg','bmp','gif','png', 'zip', 'rar', '7z', 'pdf', 'tga', 'ai', 'psd', 'dwg', 'fbx', 'obj', 'stl'], // дефолтные допустимые расширения для файлов
