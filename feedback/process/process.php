...
MAX_FILE_SIZE = 500000000, // максимальный размер файла (в байтах)
ALLOWED_EXTENSIONS = array('jpg','jpeg','bmp','gif','png', 'zip', 'rar', '7z', 'pdf', 'tga', 'ai', 'psd', 'dwg', 'fbx', 'obj', 'stl'), // разрешённые расширения файлов
MAIL_FROM = 'manager@nrml.tech', // от какого email будет отправляться письмо
MAIL_FROM_NAME = 'nrml.tech', // от какого имени будет отправляться письмо
MAIL_SUBJECT = 'Сообщение с формы обратной связи', // тема письма
MAIL_ADDRESS = 'manager@nrml.tech', // кому необходимо отправить письмо
...
MAIL_SMTP_HOST = 'ssl://mail.nic.ru', // SMTP-хост
MAIL_SMTP_PORT = '465', // SMTP-порт
MAIL_SMTP_USERNAME = 'manager@nrml.tech', // SMTP-пользователь
MAIL_SMTP_PASSWORD = 'RobotDyn1397'; // SMTP-пароль
